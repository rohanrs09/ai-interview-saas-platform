...
CREATE TABLE "interview_questions" (
	...
	"type" "question_type" DEFAULT 'technical' NOT NULL,
...
ALTER TABLE "job_descriptions" ADD CONSTRAINT "job_descriptions_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
